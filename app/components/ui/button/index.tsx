...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      primary:
        "bg-primary-500 data-[hover=true]:bg-primary-600 data-[active=true]:bg-primary-700 border-background-500 data-[hover=true]:border-primary-400 data-[active=true]:border-primary-500 data-[focus-visible=true]:web:ring-indicator-info",
      secondary:
...
const buttonTextStyle = tva({
  base: "text-typography-0 font-semibold web:select-none !border-0",
  parentVariants: {
    action: {
